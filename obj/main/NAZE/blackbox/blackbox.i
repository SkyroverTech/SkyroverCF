...
# 809 "./src/main/blackbox/blackbox.c"
        ...
        const void *secondFieldDefinition, int fieldCount, const uint8_t *conditions, const uint8_t *secondCondition)
{
    ...
    if (xmitState.u.fieldIndex == -1) {
        ...
        charsWritten = blackboxPrintf("H Field %c %s:", xmitState.headerIndex >= ((sizeof((blackboxFieldHeaderNames))/sizeof((blackboxFieldHeaderNames)[0])) - 2) ? deltaFrameChar : mainFrameChar, blackboxFieldHeaderNames[xmitState.headerIndex]);
