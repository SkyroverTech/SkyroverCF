...
static void resetConf(void)
{
    ...
    for (i = 0; i < (18); i++) {
        ...
        channelFailsafeConfiguration->step = (i == THROTTLE) ? masterConfig.rxConfig.rx_min_usec : ((constrain(masterConfig.rxConfig.midrc, 750, 2250) - 750) / 25);
    }
    ...
    for (i = 0; i < 8; i++) {
        ...
        currentProfile->servoConf[i].angleAtMin = 90;
        currentProfile->servoConf[i].angleAtMax = 90;
