...
void showCurrentPortInfo(void);
# 134 "./src/main/io/serial_msp.c"
...
static _Bool processOutCommand(uint8_t cmdMSP)
{
    ...
    case 109:
        ...
        serialize32(baroCalculateAltitude());
        serialize16(vario);
        break;
    case 58:
        headSerialReply(4);
...
void showCurrentPortInfo(void)
{
    tfp_printf("currentPort->c_state:%d\r\n",currentPort->c_state);
    tfp_printf("currentPort->dataSize:%d\r\n",currentPort->dataSize);
    tfp_printf("currentPort->offset:%d\r\n",currentPort->offset);
    tfp_printf("currentPort->checksum:%d\r\n",currentPort->checksum);
    tfp_printf("currentPort->cmdMSP:%d\r\n",currentPort->cmdMSP);
    tfp_printf("currentPort->inBuf:%s\r\n",currentPort->inBuf);
}
