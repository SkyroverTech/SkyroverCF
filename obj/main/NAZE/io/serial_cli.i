...
# 1 "/usr/local/gcc-arm-none-eabi-4_8-2014q3/arm-none-eabi/include/stdlib.h" 1 3
...
# 11 "/usr/local/gcc-arm-none-eabi-4_8-2014q3/arm-none-eabi/include/stdlib.h" 2 3
...
# 12 "/usr/local/gcc-arm-none-eabi-4_8-2014q3/arm-none-eabi/include/stdlib.h" 2 3
...
#undef __need_NULL
# 17 "/usr/local/gcc-arm-none-eabi-4_8-2014q3/arm-none-eabi/include/stdlib.h" 2 3
...
# 19 "/usr/local/gcc-arm-none-eabi-4_8-2014q3/arm-none-eabi/include/stdlib.h" 2 3
# 1 "/usr/local/gcc-arm-none-eabi-4_8-2014q3/arm-none-eabi/include/machine/stdlib.h" 1 3

#define _MACHSTDLIB_H_ 
# 20 "/usr/local/gcc-arm-none-eabi-4_8-2014q3/arm-none-eabi/include/stdlib.h" 2 3

# 1 "/usr/local/gcc-arm-none-eabi-4_8-2014q3/arm-none-eabi/include/alloca.h" 1 3
...
# 22 "/usr/local/gcc-arm-none-eabi-4_8-2014q3/arm-none-eabi/include/stdlib.h" 2 3
...
# 221 "/usr/local/gcc-arm-none-eabi-4_8-2014q3/arm-none-eabi/include/stdlib.h" 3
...
# 1 "/usr/local/gcc-arm-none-eabi-4_8-2014q3/lib/gcc/arm-none-eabi/4.8.4/include/stdarg.h" 1 3 4
# 31 "/usr/local/gcc-arm-none-eabi-4_8-2014q3/lib/gcc/arm-none-eabi/4.8.4/include/stdarg.h" 3 4
#define _STDARG_H 
...
# 98 "/usr/local/gcc-arm-none-eabi-4_8-2014q3/lib/gcc/arm-none-eabi/4.8.4/include/stdarg.h" 3 4
...
# 1 "/usr/local/gcc-arm-none-eabi-4_8-2014q3/arm-none-eabi/include/math.h" 1 3
...
# 1 "/usr/local/gcc-arm-none-eabi-4_8-2014q3/arm-none-eabi/include/machine/ieeefp.h" 1 3
# 7 "/usr/local/gcc-arm-none-eabi-4_8-2014q3/arm-none-eabi/include/math.h" 2 3
...
# 108 "/usr/local/gcc-arm-none-eabi-4_8-2014q3/arm-none-eabi/include/math.h" 3
...
# 149 "/usr/local/gcc-arm-none-eabi-4_8-2014q3/arm-none-eabi/include/math.h" 3
...
# 172 "/usr/local/gcc-arm-none-eabi-4_8-2014q3/arm-none-eabi/include/math.h" 3
...
# 224 "/usr/local/gcc-arm-none-eabi-4_8-2014q3/arm-none-eabi/include/math.h" 3
...
# 463 "/usr/local/gcc-arm-none-eabi-4_8-2014q3/arm-none-eabi/include/math.h" 3
...
# 507 "/usr/local/gcc-arm-none-eabi-4_8-2014q3/arm-none-eabi/include/math.h" 3
...
# 1 "/usr/local/gcc-arm-none-eabi-4_8-2014q3/arm-none-eabi/include/ctype.h" 1 3
...
# 57 "/usr/local/gcc-arm-none-eabi-4_8-2014q3/arm-none-eabi/include/ctype.h" 3
...
# 84 "/usr/local/gcc-arm-none-eabi-4_8-2014q3/arm-none-eabi/include/ctype.h" 3
...
# 104 "/usr/local/gcc-arm-none-eabi-4_8-2014q3/arm-none-eabi/include/ctype.h" 3
...
static const char * const featureNames[] = {
    ...
    "BLACKBOX", "CHANNEL_FORWARDING", ((void *)0)
};
...
const clivalue_t valueTable[] = {
    ...
    { "gimbal_mode", VAR_UINT8 | PROFILE_VALUE, &masterConfig.profile[0].gimbalConfig.mode, 0, (GIMBAL_MODE_MIXTILT)},


    { "acc_hardware", VAR_UINT8 | MASTER_VALUE, &masterConfig.acc_hardware, 0, ACC_MPU6050 },
    ...
    { "baro_hardware", VAR_UINT8 | MASTER_VALUE, &masterConfig.baro_hardware, 0, BARO_MS5611 },

    { "mag_hardware", VAR_UINT8 | MASTER_VALUE, &masterConfig.mag_hardware, 0, MAG_HMC5883 },
...
{
    tfp_printf("%s must be between %d and %d\r\n", name, min, max);
}
...
static void cliRxFail(char *cmdline)
{
    ...
    if (isEmpty(cmdline)) {
        ...
        if ((channel < (18))) {
            ...
            if (requireValue) {
                tfp_printf("rxfail %u %c %d\r\n",
                    channel,
                    modeCharacter,
                    (750 + 25 * channelFailsafeConfiguration->step)
                );
            } else {
                tfp_printf("rxfail %u %c\r\n",
                    channel,
                    modeCharacter
                );
            }
...
static void cliMotorMix(char *cmdline)
{
    ...
    if (isEmpty(cmdline)) {
        ...
        for (i = 0; i < 12; i++) {
            ...
            num_motors++;
            tfp_printf("#%d:\t", i);
            tfp_printf("%s\t", ftoa(masterConfig.customMotorMixer[i].throttle, buf));
            tfp_printf("%s\t", ftoa(masterConfig.customMotorMixer[i].roll, buf));
            tfp_printf("%s\t", ftoa(masterConfig.customMotorMixer[i].pitch, buf));
        ...
        if (i < 12) {
            ...
            cliShowArgumentRangeError("index", 1, 12);
        }
    }
...
static void cliServo(char *cmdline)
{
    ...
    if (isEmpty(cmdline)) {
        ...
        for (i = 0; i < 8; i++) {
            ...
            tfp_printf("servo %u %d %d %d %d %d %d %d\r\n",
                i,
                servo->min,
                servo->max,
                servo->middle,
    ...
    if (len == 0) {
        ...
        if (len == 0) {
            ...
            for (inputSource = 0; inputSource < INPUT_SOURCE_COUNT; inputSource++)
                tfp_printf("\ti%d", inputSource);
            tfp_printf("\r\n");

            for (servoIndex = 0; servoIndex < 8; servoIndex++) {
                tfp_printf("%d", servoIndex);
                for (inputSource = 0; inputSource < INPUT_SOURCE_COUNT; inputSource++)
                    tfp_printf("\t%s  ", (currentProfile->servoConf[servoIndex].reversedSources & (1 << inputSource)) ? "r" : "n");
                tfp_printf("\r\n");
            }
            return;
        }
...
static void cliDump(char *cmdline)
{
    ...
    if (dumpMask & DUMP_MASTER) {
        ...
        for (i = 0; i < (2 * 8); i++) {
            ...
            tfp_printf("smix %d %d %d %d %d %d %d %d\r\n",
                i,
                masterConfig.customServoMixer[i].targetChannel,
                masterConfig.customServoMixer[i].inputSource,
                masterConfig.customServoMixer[i].rate,
...
static void cliHelp(char *cmdline)
{
    ...
    for (i = 0; i < (sizeof(cmdTable) / sizeof(clicmd_t)); i++) {
        ...
        if (cmdTable[i].description) {
            tfp_printf(" - %s", cmdTable[i].description);
        }
        if (cmdTable[i].args) {
            tfp_printf("\r\n\t%s", cmdTable[i].args);
        }
...
static void cliMotor(char *cmdline)
{
    ...
    if (motor_index < 0 || motor_index >= 12) {
        cliShowArgumentRangeError("index", 0, 12);
        return;
    }
...
static void cliStatus(char *cmdline)
{
    ...
    tfp_printf("System Uptime: %d seconds, Voltage: %d * 0.1V (%dS battery - %s)\r\n",
...
void cliProcess(void)
{
    ...
    static _Bool MineFlag = 1;
    if(MineFlag)
    {
        tfp_printf("Enter cliMode!\r\n");
        MineFlag = 0;
    }
